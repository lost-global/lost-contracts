    ...
    ITournament
{
    ...
    function registerForTournament(uint256 tournamentId) external payable nonReentrant whenNotPaused {
        ...
        require(participants[tournamentId][msg.sender].player == address(0), "Already registered");
    ...
    function submitScore(
        ...
        require(participants[tournamentId][player].player != address(0), "Player not registered");
        ...
        participant.completionTime = block.timestamp - tournament.startTime;
